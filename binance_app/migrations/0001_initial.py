    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='binance_app.Market')),
            ],
            options={
                'get_latest_by': 'time',
                'abstract': False,
        ...
        migrations.AddField(
            model_name='order',
            name='orderbook',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='binance_app.OrderBook'),
        ),
        ...
        migrations.AddIndex(
            model_name='ticker',
            index=models.Index(fields=['time'], name='binance_app_time_e6aa7f_idx'),
        ),
    ]
